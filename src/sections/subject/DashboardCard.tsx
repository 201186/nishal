...
export default function DashboardCard({
  ...
  return (
    ...
    >
      ...
      <div className="p-8">
        <div
          className={`flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br transition-all duration-300 group-hover:scale-110 group-hover:rotate-6 ${
            colorClasses[color] ?? colorClasses.blue
          }`}
        >
